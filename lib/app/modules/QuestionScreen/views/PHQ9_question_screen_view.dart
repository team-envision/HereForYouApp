...
class PHQ9QuestionView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final PHQ9QuestionController controller = Get.put(PHQ9QuestionController());
    ...
    return Scaffold(
        ...
        actions: [
          Padding(
            ...
            child: Center(
              child: Obx(() {
                return Text(
                  "${controller.currentQuestionIndex.value + 1}/${controller.PHQ9questions.length}",
      ...
      body: Obx(() {
        if (controller.PHQ9questions.isEmpty) {
          return const Center(
