...
import 'package:here_for_you_app/app/modules/SleepDiary/controllers/sleep_score_controller.dart';
import 'package:here_for_you_app/app/views/views/articles_view.dart';

class SleepScoreView extends GetView<SleepScoreController> {
 const SleepScoreView({super.key});
